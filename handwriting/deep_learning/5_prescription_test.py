...
print("=" * 70)
print("FINE-TUNED TrOCR — PRESCRIPTION TEST")
print("=" * 70)
...
print(f"Loading prescription image: {IMAGE_PATH}")
...
print("Running OCR without dictionary correction...\n")
